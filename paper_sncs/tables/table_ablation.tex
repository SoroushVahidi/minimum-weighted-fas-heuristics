\begin{table}[t]
\centering
\caption{Compact ablation study on 10 representative sparse instances. Relative change is measured against LR-TA. Negative percentages indicate improvement.}
\label{tab:ablation}
\begin{tabular}{lrrr}
\toprule
