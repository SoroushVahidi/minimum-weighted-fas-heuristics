...
Reproducible randomization & IPSNS SCC selection is score-weighted random and determined by the configured random seed; destroy prefixes and repair are deterministic conditional on the selected SCC and current state. \\
\bottomrule
\end{tabular}
\end{table}
