...
This case study applies the MWFAS framework to a real social-network dataset
with a natural application framing.
...
- No author-identifying information is included in the packaged data or filenames.
