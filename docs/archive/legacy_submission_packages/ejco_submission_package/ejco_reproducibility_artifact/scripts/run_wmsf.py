#!/usr/bin/env python3
"""Run the WMSF algorithm on a single DIMACS instance."""
...
def main():
    parser = argparse.ArgumentParser(description="WMSF heuristic for weighted MFAS (paper049)")
    ...
    parser.add_argument("--ordering", choices=["L1", "L2"], default="L2",
                        help="Arc ordering for removeArcs step (default: L2)")
