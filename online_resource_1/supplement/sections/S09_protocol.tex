...
\paragraph{Statistics.} EXP4/EXP10 paired tests: Wilcoxon signed-rank and sign test, two-sided; bootstrap CI (seed 42, 10,000 resamples). Relative reduction achieved by IPSNS: $(\mathrm{DR}-\mathrm{IPSNS})/\mathrm{DR}\times 100$.
