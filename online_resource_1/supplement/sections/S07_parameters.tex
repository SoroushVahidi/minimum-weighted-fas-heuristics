...
DRMacIver reps & EXP10 & 20 & Frozen & PID/time seeding \\
Tie tolerance & EXP10 & $10^{-9}$ & Frozen & Median comparison \\
\bottomrule
\end{tabular}
\end{table}

Holdout and sensitivity summaries: \texttt{results/coap\_ipsns\_sensitivity/}. EXP10 confirms frozen IPSNS configuration showed zero cross-seed objective variation on 93/93 instances.
