...
Holdout and sensitivity summaries: \texttt{results/coap\_ipsns\_sensitivity/}. EXP10 confirms the fixed IPSNS configuration showed zero cross-seed objective variance on 93/93 instances, while 87.1\% of IPSNS runs accepted no improving move. Paired IPSNS-versus-better-seed summary on 97 standard instances: 14 strict improvements, 83 ties, 0 regressions; mean absolute gain 571 BW units (0.42\% relative); per-instance detail in \texttt{experiments/exp1b\_core\_benchmark\_full\_wmsf\_seed/tables/exp1b\_core\_benchmark\_paper\_summary.csv}.
