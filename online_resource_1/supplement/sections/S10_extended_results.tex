...
The revised main paper keeps only the principal tables needed for the IPSNS-centered sparse narrative. The following supporting items are therefore documented here.
