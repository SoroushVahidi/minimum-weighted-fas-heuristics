...
The application-facing Wikipedia vote case study (EXP9) gives a deliberately different picture: on the dense vote-degree subgraph ($n{=}50$, $m{=}752$, density $= 0.307$), DRMacIver/FAS achieves backward weight 135 while IPSNS ties LR-TA at 141, consistent with the structural boundary observed on LOLIB (Table~\ref{tab:application-case}).
