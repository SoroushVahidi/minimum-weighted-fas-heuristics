...
\begin{figure}[t]
    ...
    \caption{Global-best counts by LOLIB family for IPSNS and DRMacIver/FAS. The family split makes the dense-scope boundary explicit: DRMacIver/FAS is stronger overall, while IPSNS remains competitive on the IO family.}
