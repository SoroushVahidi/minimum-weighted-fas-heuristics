...
The reproducibility story also includes transparent handling of exclusions and incompletions. Negative-weight sparse instances are excluded from the standard claim-bearing benchmark because they do not match the nonnegative setting studied in the manuscript. DRMaciver incompletions on the sparse benchmark are reported explicitly rather than hidden in filtered tables. The dense LOLIB transfer test is retained even though it narrows the paper's claim surface, because that honesty is part of the contribution: the framework is strong on sparse weighted digraphs and bounded on dense complete ordering instances.
